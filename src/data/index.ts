...
export const profile = {
  ...
  resumePdf: "/resume.pdf?v=5", // Europass-format CV; bump when public/resume.pdf is regenerated
  valueProp:
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    blurb:
      "The read API for master data: I split the read and write paths into clean interfaces, hardened the auth, and kept it quick.",
